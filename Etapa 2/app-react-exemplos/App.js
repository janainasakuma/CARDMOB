...
const API_URL = 'http://10.81.205.12:5000/api/catalog'; 
      ...
      return (
        <View style={styles.item}>
          ...
          <View style={styles.buttons}>
            <Button title="Editar" color="hotpink" onPress={() => {
              setEditId(item.id);
              setEditName(item.name);
              setEditDescription(item.description);
              setEditPrice(String(item.price));
            }} />
            <Button title="Excluir" color="darkred" onPress={() => deleteProduct(item.id)} />
          </View>
        </View>
      );
    } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        placeholder="Preço"
      />
      <Button title="Adicionar Produto" color="deeppink" onPress={createProduct} />
